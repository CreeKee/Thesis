...
HD_PWD='E:/Seth stuff/Thesis/Thesis/Thesis.runs/floating_point_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log floating_point_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source floating_point_0_1.tcl
